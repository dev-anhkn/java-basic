1. 📌 ĐỊNH NGHĨA (DEFINITION)
    ...
    - Mục tiêu:
        - Cung cấp giao diện chung để tạo đối tượng, cho phép lớp con quyết định class cụ thể nào sẽ được khởi
          tạo.
        - Thay vì dùng từ khóa new, đối tượng sẽ được tạo ra thông qua phương thức factory, giúp tách biệt quá trình
          khởi tạo và sử dụng.
...
4. ⚙️ THÀNH PHẦN (COMPONENTS)
    - 📌 Factory Method
        - Product: Interface/abstract class cho các đối tượng được tạo
...
* 📌 KẾT LUẬN
    - Factory Pattern giúp quản lý việc khởi tạo đối tượng một cách linh hoạt, tách biệt việc sử dụng và tạo mới, phù
      hợp cho các hệ thống cần mở rộng dễ dàng theo hướng plug-in hoặc nhiều kiểu sản phẩm tương thích. Tuy nhiên, cần
      cân nhắc giữa lợi ích và độ phức tạp thêm vào.