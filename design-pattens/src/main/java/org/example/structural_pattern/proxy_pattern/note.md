1. ĐỊNH NGHĨA (Definition)
    - Proxy Pattern là một mẫu thiết kế cấu trúc (Structural Design Pattern) cung cấp một đối tượng thay thế (proxy) cho
      một đối tượng khác (real object), nhằm kiểm soát truy cập, bổ sung hành vi hoặc tối ưu hiệu năng, mà không làm
      thay đổi logic của đối tượng gốc.
